                ...
                {MenuLayer.map((item, index) => (
                    ...
                    >
                        ...
                        <div className="bg-[#3A2B28] pb-[20px] pt-[16px] pl-[12px] pr-[12px] flex flex-col gap-[2.8px] sm:gap-[4px] md:gap-[8px] lg:gap-[12px] xl:gap-[8px] xl:border-r-[1px] border-[#686868]">
                            ...
                            <p className="text-[14px] leading-[20px] font-CreatoDisplay font-normal text-[#C2C2C2] sm:text-[22px] sm:leading-[30px] md:text-[20px] md:leading-[26px] lg:text-[28px] lg:leading-[38px] xl:text-[15px] xl:leading-[23px] 2xl:text-[18px] 2xl:leading-[24px] xl:h-[50px]">
                                {item.desc}
                            </p>
